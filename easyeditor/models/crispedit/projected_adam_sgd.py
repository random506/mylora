...
class ProjectedSGD(SGD):
    """
    SGD with the soft K-FAC preconditioner used by CrispEdit.
    ...
    The transformed gradient is then passed to torch.optim.SGD, so momentum,
    dampening, Nesterov acceleration, weight decay, and maximize retain their
    native PyTorch semantics.
    """
